...
const Login = () => {
  ...
  return (
    <div 
      ...
      style={{ backgroundImage: "url('https://alcorfund.com/wp-content/uploads/2020/09/Investors.png')" }}
    >
      <div className="max-w-md mx-auto mt-10 p-6 bg-gradient-to-br from-purple-100 to-indigo-100 rounded-lg shadow-lg backdrop-blur-sm">
